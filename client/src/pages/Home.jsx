...
const Home = () => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      {/* Platform Snapshot (Real Data State) */}
      <section className="w-full max-w-6xl mx-auto py-16 px-4">
        <div className="bg-sand p-8 rounded-xl border border-deep-green/10 text-center">
          <h3 className="text-3xl font-bold text-deep-green mb-4">Be among the first to report an issue!</h3>
          <p className="text-ink/70 text-lg mb-6 max-w-2xl mx-auto">
            Our community is just getting started. Your reports help authorities prioritize and fix critical infrastructure problems faster.
          </p>
          <Link to="/report" className="inline-block border-2 border-deep-green text-deep-green px-6 py-2 rounded-lg font-bold hover:bg-deep-green/5 transition-all">
            Make a Report
          </Link>
        </div>
      </section>
